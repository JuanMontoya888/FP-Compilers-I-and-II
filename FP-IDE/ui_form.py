...
"}")
        ...
        self.textEdit.setGeometry(QRect(3, 0, 16777215, 16777215))
        ...
        self.gridLayout_2.addWidget(self.splitter, 1, 0, 1, 11)
        ...
        self.gridLayout_2.addWidget(self.toolsButton, 0, 7, 1, 1)
